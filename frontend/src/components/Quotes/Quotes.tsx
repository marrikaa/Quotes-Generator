...
const Quotes = (props : PropType) => {
    const { quote, isForFav, isForHome, name, removeCklickHandler} = props;
    ...
    return (
        ...
        {name !== "" && !isForFav && !isForHome &&<button className='quote-button' value={JSON.stringify(quote)} onClick={addcklickHandler}>Add in my list</button>}
